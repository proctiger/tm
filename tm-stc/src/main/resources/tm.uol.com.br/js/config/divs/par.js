...
TM.urlConfBanners = [
    ...
    {
        're'      : /^http(s)?:\/\/(www[0-9]*.)?(operamundi|sulamericaparadiso|revistasamuel)(.(bol|uol))?.com(.br)?(\/.*)?$/,
        'banners' : [
            {
                'id'    : 'banner-180x150',
                'width' : 180, 
    ...
    {
        're'      : /^http(s)?:\/\/(www[0-9]*.)?(noticiasdatv)(.(bol|uol))?.com(.br)?(\/.*)?$/,
        'banners' : [
            {
                'id'    : 'banner-300x250-2',
                'dfppos': 'middle', 
    ...
    {
        're'      : /^http(s)?:\/\/(www[0-9]*.)?(ultimainstancia)(.(bol|uol))?.com(.br)?(\/.*)?$/,
        'banners' : [
            {
                'id' : 'banner-300x58',
                'dfpPos': 'top',
    ...
    {
        're'      : /^http(s)?:\/\/terceirotempo.bol.uol.com.br?(\/.*)?$/,
        'banners' : [
            {
                'id': 'banner-200x446',
                'pos': 9,
    ...
    {
        're'      : /^http(s)?:\/\/natelinha.ne10.uol.com.br(\/.*)?$/,
        'banners' : [
            {
                'id': 'banner-300x250-2',
                'dfpPos': 'middle', 
    ...
    {
        're'      : /^http(s)?:\/\/(www[0-9]*.)?(caranddriverbrasil)(.(bol|uol))?.com(.br)?(\/.*)?$/,
        'banners' : [
            {
                'id': 'banner-120x600',
                'pos': 6,
    ...
    {
        're'      : /^http(s)?:\/\/(www[0-9]*.)?itmae(.(bol|uol))?.com(.br)?(\/.*)?$/,
        'banners' : [
            {
                'id': 'banner-728x90-2',
                'dfpPos': 'middle',
