...
var CookieUtils = function () {
    ...
    this.setCookie = function (name, value, expire, path, domain) {
...
var Siga = function () {
    ...
    var log = function (message) {
        var pattern = '[UOL Tag Manager]';
        var lg = new LogUtils(pattern);
        lg.log(message);
    };
    ...
    this.setupBannerConfig = function (banner, attributes) {
        ...
        if (!config['coddisplaysupplier']) {
            warn('Código do usuário não definido para os anúncios do UOL Cliques');
            return false;
        }
    ...
    this.getAttributes = function (div) {
        ...
        if (!attributes['size']) {
            warn('Algum anúncio de UOL Cliques não possui a chave size no atributo [siga] e será descartado');
            return false;
        }
        return attributes;
    };
    ...
    this.validateBanner = function (attributes, div) {
        ...
        if (!found) {
            if (attributes['size']) {
                warn('O banner de UOL Cliques com size ['+ attributes['size'] +'] é inválido e será descartado');
            }
            return false;
        }
        return banner
