...
TM.urlConfBanners = [
    ...
    {
        're'      : /^http(s)?:\/\/esporte.uol.com.br\/futebol\/campeonatos\/brasileiro\/2013\/serie-a(\/.*)?$/,
        'banners' : [
            {
                'id': 'banner-120x35-2',
                'dfpPos': 'top',
    ...
    {
        're'      : /^http(s)?:\/\/(economia|guia|mulher|((nagradedomma|reginanavarro).blogosfera)).uol.com.br(\/.*)?$/,
        'banners' : [
            {
                'id': 'banner-120x35',
                'dfpPos': 'top',
